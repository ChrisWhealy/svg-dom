...
pub enum TurbulenceType {
    ...
    /// same as summing first and taking the absolute value of the total.
    /// The per-octave version cannot have positive and negative octaves cancel each other.
    /// This is what gives this variant its higher contrast relative to [`FractalNoise`](Self::FractalNoise).
    Turbulence,
