...
/// Every demo sub-module's source is keyed by its own module path and embedded at build time, so each panel can display
/// the exact code that drives it. A single flat `concat!`-ed blob (searched by bare function name alone) is not enough
/// once more than one file can define a same-named function, so [`demo_fn_source`] searches only the one file named
/// here, selected by the module path half of [`DEMO_PANELS`]'s own recorded `stringify!($path)` (see [`split_demo_path`]).
///
...
///
/// Adding a new module to `demo_gallery!` below means adding its file here too — nothing enforces that automatically,
/// the same as any other `include_str!` list.
const DEMO_SOURCE_FILES: &[(&str, &str)] = &[
    (
        stringify!(events::demo_events_classlist),
        include_str!("events/demo_events_classlist.rs"),
    ),
    (
        stringify!(events::demo_events_click),
        include_str!("events/demo_events_click.rs"),
    ),
    (
        stringify!(events::demo_events_colour),
        include_str!("events/demo_events_colour.rs"),
    ),
    (
        stringify!(events::demo_events_drag_drop_touch),
        include_str!("events/demo_events_drag_drop_touch.rs"),
    ),
    (
        stringify!(events::demo_events_group),
        include_str!("events/demo_events_group.rs"),
    ),
    (
        stringify!(events::demo_events_keyboard_wheel),
        include_str!("events/demo_events_keyboard_wheel.rs"),
    ),
    (
        stringify!(events::demo_events_modifiers),
        include_str!("events/demo_events_modifiers.rs"),
    ),
    (
        stringify!(events::demo_events_passive),
        include_str!("events/demo_events_passive.rs"),
    ),
    (
        stringify!(events::demo_events_pointer_lifecycle),
        include_str!("events/demo_events_pointer_lifecycle.rs"),
    ),
    (
        stringify!(events::demo_events_press),
        include_str!("events/demo_events_press.rs"),
    ),
    (
        stringify!(geometry::demo_geometry_bounding_box),
        include_str!("geometry/demo_geometry_bounding_box.rs"),
    ),
    (
        stringify!(geometry::demo_geometry_path_follow),
        include_str!("geometry/demo_geometry_path_follow.rs"),
    ),
    (stringify!(paint::demo_blend), include_str!("paint/demo_blend.rs")),
    (stringify!(paint::demo_clip_path), include_str!("paint/demo_clip_path.rs")),
    (stringify!(paint::demo_color_matrix), include_str!("paint/demo_color_matrix.rs")),
    (
        stringify!(paint::demo_component_transfer),
        include_str!("paint/demo_component_transfer.rs"),
    ),
    (
        stringify!(paint::demo_convolve_matrix),
        include_str!("paint/demo_convolve_matrix.rs"),
    ),
    (stringify!(paint::demo_fe_image), include_str!("paint/demo_fe_image.rs")),
    (stringify!(paint::demo_fe_tile), include_str!("paint/demo_fe_tile.rs")),
    (stringify!(paint::demo_filter), include_str!("paint/demo_filter.rs")),
    (
        stringify!(paint::demo_light_sources),
        include_str!("paint/demo_light_sources.rs"),
    ),
    (stringify!(paint::demo_lighting), include_str!("paint/demo_lighting.rs")),
    (
        stringify!(paint::demo_linear_gradient),
        include_str!("paint/demo_linear_gradient.rs"),
    ),
    (stringify!(paint::demo_mask), include_str!("paint/demo_mask.rs")),
    (stringify!(paint::demo_morphology), include_str!("paint/demo_morphology.rs")),
    (stringify!(paint::demo_pattern), include_str!("paint/demo_pattern.rs")),
    (
        stringify!(paint::demo_radial_gradient),
        include_str!("paint/demo_radial_gradient.rs"),
    ),
    (stringify!(paint::demo_turbulence), include_str!("paint/demo_turbulence.rs")),
    (stringify!(shapes::demo_circle), include_str!("shapes/demo_circle.rs")),
    (stringify!(shapes::demo_ellipse), include_str!("shapes/demo_ellipse.rs")),
    (stringify!(shapes::demo_line), include_str!("shapes/demo_line.rs")),
    (stringify!(shapes::demo_path), include_str!("shapes/demo_path.rs")),
    (stringify!(shapes::demo_poly), include_str!("shapes/demo_poly.rs")),
    (stringify!(shapes::demo_rect), include_str!("shapes/demo_rect.rs")),
    (
        stringify!(structure::demo_accessibility),
        include_str!("structure/demo_accessibility.rs"),
    ),
    (stringify!(structure::demo_anchor), include_str!("structure/demo_anchor.rs")),
    (stringify!(structure::demo_anim), include_str!("structure/demo_anim.rs")),
    (
        stringify!(structure::demo_foreign_object),
        include_str!("structure/demo_foreign_object.rs"),
    ),
    (stringify!(structure::demo_group), include_str!("structure/demo_group.rs")),
    (stringify!(structure::demo_image), include_str!("structure/demo_image.rs")),
    (
        stringify!(structure::demo_marker_view_box),
        include_str!("structure/demo_marker_view_box.rs"),
    ),
    (stringify!(structure::demo_marker), include_str!("structure/demo_marker.rs")),
    (stringify!(structure::demo_style), include_str!("structure/demo_style.rs")),
    (stringify!(structure::demo_switch), include_str!("structure/demo_switch.rs")),
    (stringify!(structure::demo_symbol), include_str!("structure/demo_symbol.rs")),
    (stringify!(structure::demo_tree_nav), include_str!("structure/demo_tree_nav.rs")),
    (stringify!(structure::demo_use), include_str!("structure/demo_use.rs")),
    (stringify!(structure::demo_view_box), include_str!("structure/demo_view_box.rs")),
    (stringify!(structure::demo_view), include_str!("structure/demo_view.rs")),
...
demo_gallery! {
    "panel-accessibility" => structure::demo_accessibility::demo,
    "panel-anchor" => structure::demo_anchor::demo,
    "panel-anim" => structure::demo_anim::demo,
    "panel-blend" => paint::demo_blend::demo,
    "panel-circle" => shapes::demo_circle::demo,
    "panel-clip-path" => paint::demo_clip_path::demo,
    "panel-color-matrix" => paint::demo_color_matrix::demo,
    "panel-component-transfer" => paint::demo_component_transfer::demo,
    "panel-convolve-matrix" => paint::demo_convolve_matrix::demo,
    "panel-ellipse" => shapes::demo_ellipse::demo,
    "panel-events-classlist" => events::demo_events_classlist::demo,
    "panel-events-click" => events::demo_events_click::demo,
    "panel-events-colour" => events::demo_events_colour::demo,
    "panel-events-drag-drop-touch" => events::demo_events_drag_drop_touch::demo,
    "panel-events-group" => events::demo_events_group::demo,
    "panel-events-keyboard-wheel" => events::demo_events_keyboard_wheel::demo,
    "panel-events-modifiers" => events::demo_events_modifiers::demo,
    "panel-events-passive" => events::demo_events_passive::demo,
    "panel-events-pointer" => events::demo_events_pointer_lifecycle::demo,
    "panel-events-press" => events::demo_events_press::demo,
    "panel-fe-image" => paint::demo_fe_image::demo,
    "panel-fe-tile" => paint::demo_fe_tile::demo,
    "panel-filter" => paint::demo_filter::demo,
    "panel-foreign-object" => structure::demo_foreign_object::demo,
    "panel-geometry-bbox" => geometry::demo_geometry_bounding_box::demo,
    "panel-geometry-path-follow" => geometry::demo_geometry_path_follow::demo,
    "panel-group" => structure::demo_group::demo,
    "panel-image" => structure::demo_image::demo,
    "panel-light-sources" => paint::demo_light_sources::demo,
    "panel-lighting" => paint::demo_lighting::demo,
    "panel-line" => shapes::demo_line::demo,
    "panel-linear-gradient" => paint::demo_linear_gradient::demo,
    "panel-marker-view-box" => structure::demo_marker_view_box::demo,
    "panel-marker" => structure::demo_marker::demo,
    "panel-mask" => paint::demo_mask::demo,
    "panel-morphology" => paint::demo_morphology::demo,
    "panel-path" => shapes::demo_path::demo,
    "panel-pattern" => paint::demo_pattern::demo,
    "panel-poly" => shapes::demo_poly::demo,
    "panel-radial-gradient" => paint::demo_radial_gradient::demo,
    "panel-rect" => shapes::demo_rect::demo,
    "panel-style" => structure::demo_style::demo,
    "panel-switch" => structure::demo_switch::demo,
    "panel-symbol" => structure::demo_symbol::demo,
    "panel-text-path" => texts::demo_text_path::demo,
    "panel-text" => texts::demo_text::demo,
    "panel-tree-nav" => structure::demo_tree_nav::demo,
    "panel-tspan" => texts::demo_tspan::demo,
    "panel-turbulence" => paint::demo_turbulence::demo,
    "panel-use" => structure::demo_use::demo,
    "panel-view-box" => structure::demo_view_box::demo,
    "panel-view" => structure::demo_view::demo,
}
