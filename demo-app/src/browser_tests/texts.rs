...
fn demo_text_radio_groups_update_their_target_attributes() {
    container("demo-text");
    crate::texts::demo_text::demo().expect("demo_text::demo should build without error");
...
fn start_offset_slider_updates_position_colour_text_and_stays_within_the_path_length() {
    ...
    crate::texts::demo_text_path::demo().expect("demo_text_path::demo should build without error");
